...
const CONTACT_INFO = [
  {
    ...
    bg: "from-[#1b3a5c] to-[#d93a2b]",
  },
  {
    icon: Phone,
    title: "Phone",
    lines: ["+977-1-4XXXXXX", "+977-98XXXXXXXX"],
    bg: "from-[#d93a2b] to-[#1b3a5c]",
  },
  {
    icon: Mail,
    title: "Email",
  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[45vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0" style={{ background: "linear-gradient(135deg, var(--page-hero-from, #1b3a5c), var(--page-hero-to, #d93a2b))" }} />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 text-center">
          ...
          >
            Contact{" "}
            <span className="bg-gradient-to-r from-[#d93a2b] via-[#f55959] to-[#d93a2b] bg-clip-text text-transparent">Us</span>
          </motion.h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <FadeInSection>
              ...
              <h2 className="text-3xl md:text-4xl font-display font-bold dark:text-white mb-6" style={{ color: "var(--page-text, #1a1a1a)" }}>Drop Us a Line</h2>
              <Card className="border-0 shadow-lg bg-white dark:bg-gray-800 rounded-xl">
                <CardContent className="p-6 md:p-8">
                  {submitted ? (
                    <div className="text-center py-10">
                      <div className="w-20 h-20 rounded-full bg-[#e8eef7] dark:bg-[#12283f]/60 flex items-center justify-center mx-auto mb-6">
                        <CheckCircle className="w-10 h-10 text-[#1b3a5c] dark:text-[#dce5f0]" />
                      </div>
                      <h3 className="text-2xl font-display font-bold dark:text-white mb-2" style={{ color: "var(--page-text, #1a1a1a)" }}>Message Sent!</h3>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      <div className="space-y-2">
                        <Label htmlFor="name" className="dark:text-white" style={{ color: "var(--page-text, #1a1a1a)" }}><User className="w-4 h-4 inline mr-1.5" />Your Name</Label>
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="email" className="dark:text-white" style={{ color: "var(--page-text, #1a1a1a)" }}><Mail className="w-4 h-4 inline mr-1.5" />Your Email</Label>
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="subject" className="dark:text-white" style={{ color: "var(--page-text, #1a1a1a)" }}><FileText className="w-4 h-4 inline mr-1.5" />Subject</Label>
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="message" className="dark:text-white" style={{ color: "var(--page-text, #1a1a1a)" }}><MessageSquare className="w-4 h-4 inline mr-1.5" />Message</Label>
                        <textarea
                          id="message"
                          rows={5}
                      ...
                      <Button type="submit" size="lg" className="w-full text-white shadow-lg shadow-[#d93a2b]/25 hover:brightness-110" style={{ background: "var(--page-secondary, #d93a2b)" }}>
            ...
            <div className="space-y-8">
              ...
              <FadeInSection>
                <Card className="border-0 shadow-lg bg-white dark:bg-gray-800 rounded-xl">
                  <CardContent className="p-6 md:p-8">
                    <h3 className="text-xl font-display font-bold dark:text-white mb-4" style={{ color: "var(--page-text, #1a1a1a)" }}>Connect With Us</h3>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeInSection>
            <GraduationCap className="w-12 h-12 mx-auto mb-6" style={{ color: "var(--page-accent, #d93a2b)" }} />
            <h2 className="text-4xl md:text-5xl font-display font-bold text-white leading-tight">
              Ready to Join{" "}
              <span className="bg-gradient-to-r from-[#d93a2b] to-[#d93a2b] bg-clip-text text-transparent">Milton?</span>
            </h2>
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/admissions">
                <Button size="xl" className="text-white shadow-xl shadow-[#d93a2b]/25 group hover:brightness-110" style={{ background: "var(--page-secondary, #d93a2b)" }}>
                  Apply Now
