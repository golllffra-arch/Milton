...
const CLUBS = [
  { icon: Laptop, name: "IT Club", description: "Coding competitions, workshops, hackathons, and tech talks to sharpen your programming skills.", color: "from-[#1b3a5c] to-[#12283f]" },
  { icon: Users, name: "Debate & Public Speaking Club", description: "Sharpen your oratory skills through debates, extempore, and public speaking events.", color: "from-[#1b3a5c] to-[#12283f]" },
  { icon: Dumbbell, name: "Sports Club", description: "Organizes inter-college tournaments, fitness challenges, and recreational sports activities.", color: "from-[#1b3a5c] to-[#12283f]" },
  { icon: Palette, name: "Cultural Club", description: "Celebrates Nepal's diverse culture through dance, music, drama, and art exhibitions.", color: "from-[#d93a2b] to-[#b82e21]" },
  { icon: Heart, name: "Community Service Club", description: "Volunteer initiatives, awareness campaigns, and social outreach programs for community impact.", color: "from-[#d93a2b] to-[#b82e21]" },
  { icon: Globe, name: "Tourism & Travel Club", description: "Organizes educational tours, treks, and international exposure trips for students.", color: "from-[#1b3a5c] to-[#12283f]" },
]
...
const GALLERY_THUMBS = [
  { color: "from-[#1b3a5c] to-[#12283f]", label: "Sports Day" },
  { color: "from-[#d93a2b] to-[#b82e21]", label: "Cultural Fest" },
  { color: "from-[#1b3a5c] to-[#12283f]", label: "IT Workshop" },
  { color: "from-[#d93a2b] to-[#b82e21]", label: "Volunteer Drive" },
  { color: "from-[#1b3a5c] to-[#12283f]", label: "Study Tour" },
  { color: "from-[#1b3a5c] to-[#12283f]", label: "Debate Comp" },
]
  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[45vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0" style={{ background: "linear-gradient(135deg, var(--page-hero-from, #d93a2b), var(--page-hero-to, #1b3a5c))" }} />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 text-center">
          ...
          >
            <Badge variant="outline" className="mb-6 px-4 py-2 text-sm border-white/20 text-white/80 bg-white/5 backdrop-blur-sm">
              <Users className="w-3.5 h-3.5 mr-1.5" style={{ color: "var(--page-secondary, #1b3a5c)" }} />
              Campus Life
            </Badge>
          </motion.div>
          <motion.h1
                  ...
                  <motion.div whileHover={{ y: -6 }} className="group h-full">
                    <Card className="h-full border-0 shadow-md hover:shadow-xl transition-all duration-300 bg-white dark:bg-gray-800 rounded-xl overflow-hidden">
                      ...
                      <CardContent className="p-6">
                        <h3 className="text-xl font-display font-bold dark:text-white mb-2" style={{ color: "var(--page-text, #1a1a1a)" }}>{club.name}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <FadeInSection>
              ...
              <h2 className="text-4xl md:text-5xl font-display font-bold dark:text-white leading-tight" style={{ color: "var(--page-text, #1a1a1a)" }}>
                Sports &<br />
                <span style={{ color: "var(--page-secondary, #1b3a5c)" }}>Athletics</span>
              </h2>
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={sport.label} className="flex items-center gap-3 p-3 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                    ...
                    <span className="text-sm font-medium dark:text-white" style={{ color: "var(--page-text, #1a1a1a)" }}>{sport.label}</span>
                  </div>
                ))}
              </div>
            </FadeInSection>
            <FadeInSection>
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-[#1b3a5c] to-[#12283f] rounded-2xl p-10 shadow-xl overflow-hidden">
                ...
                <FadeInSection key={event.title}>
                  <motion.div whileHover={{ y: -4 }} className="group h-full">
                    <Card className="h-full border-0 shadow-md hover:shadow-xl transition-all duration-300 bg-white dark:bg-gray-800 rounded-xl overflow-hidden">
                      ...
                      <CardContent className="p-6">
                        <h3 className="text-lg font-display font-bold dark:text-white mb-2" style={{ color: "var(--page-text, #1a1a1a)" }}>{event.title}</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {TOURS.map((tour, index) => (
              <FadeInSection key={tour.destination}>
                <motion.div whileHover={{ y: -6 }} className="group h-full">
                  <Card className="h-full border-0 shadow-md hover:shadow-xl transition-all duration-300 bg-white dark:bg-gray-800 rounded-xl overflow-hidden">
                    <div className="bg-gradient-to-br from-[#1b3a5c] to-[#12283f] p-6 text-center relative">
      ...
      <section className="relative py-24 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(135deg, var(--page-hero-from, #d93a2b), var(--page-hero-to, #1b3a5c))" }} />
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeInSection>
            <Quote className="w-14 h-14 mx-auto mb-6" style={{ color: "var(--page-accent, #d93a2b)" }} />
            ...
            <div className="mt-8">
              <div className="w-16 h-16 rounded-full bg-[#d93a2b] flex items-center justify-center mx-auto mb-4">
              ...
              <div className="flex justify-center gap-1 mt-3">
                {Array.from({ length: 5 }).map((_: unknown, i: number) => (
                  <Star key={i} className="w-5 h-5 fill-[#d93a2b]" style={{ color: "var(--page-accent, #d93a2b)" }} />
                ))}
              </div>
            </div>
          </FadeInSection>
      ...
      <section className="py-20 dark:bg-gray-900" style={{ background: "var(--page-bg, #ffffff)" }}>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <FadeInSection>
            ...
            <h2 className="text-4xl md:text-5xl font-display font-bold dark:text-white leading-tight" style={{ color: "var(--page-text, #1a1a1a)" }}>
              Experience Milton{" "}
              <span style={{ color: "var(--page-secondary, #1b3a5c)" }}>Yourself</span>
            </h2>
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Button variant="outline" size="xl" asChild className="hover:text-white" style={{ borderColor: "var(--page-primary, #d93a2b)", color: "var(--page-primary, #d93a2b)" }}>
