    ...
    <div className="overflow-hidden">
                  ...
                  <motion.div whileHover={{ y: -6 }} className="group h-full">
                    <Card className="h-full border-0 shadow-md hover:shadow-xl transition-all duration-300 bg-white dark:bg-gray-800 rounded-xl overflow-hidden">
                      ...
                      <CardContent className="p-6">
                        <h3 className="text-xl font-display font-bold text-[#1c3557] dark:text-white mb-2">{club.name}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <FadeInSection>
              ...
              <h2 className="text-4xl md:text-5xl font-display font-bold text-[#1c3557] dark:text-white leading-tight">
                Sports &<br />
                <span className="text-[#e31c23]">Athletics</span>
              </h2>
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={sport.label} className="flex items-center gap-3 p-3 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                    ...
                    <span className="text-sm font-medium text-[#1c3557] dark:text-white">{sport.label}</span>
                  </div>
                ))}
              </div>
            </FadeInSection>
                ...
                <FadeInSection key={event.title}>
                  <motion.div whileHover={{ y: -4 }} className="group h-full">
                    <Card className="h-full border-0 shadow-md hover:shadow-xl transition-all duration-300 bg-white dark:bg-gray-800 rounded-xl overflow-hidden">
                      ...
                      <CardContent className="p-6">
                        <h3 className="text-lg font-display font-bold text-[#1c3557] dark:text-white mb-2">{event.title}</h3>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeInSection>
            <Quote className="w-14 h-14 text-[#c9a84c] mx-auto mb-6" />
      ...
      <section className="py-20 bg-[#f8f6f0] dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeInSection>
            ...
            <h2 className="text-4xl md:text-5xl font-display font-bold text-[#1c3557] dark:text-white leading-tight">
              Experience Milton{" "}
              <span className="text-[#e31c23]">Yourself</span>
            </h2>
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
