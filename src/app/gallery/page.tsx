  ...
  return (
    <div className="overflow-hidden" data-page-theme="projects">
      ...
      <section className="relative min-h-[45vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[var(--page-hero-from,#1b3f63)] via-[var(--page-hero-from,#1b3f63)]/95 to-[var(--page-hero-to,#fe0000)] z-0" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 text-center">
          ...
          >
            <Badge variant="outline" className="mb-6 px-4 py-2 text-sm border-white/20 text-white/80 bg-white/5 backdrop-blur-sm">
              <Camera className="w-3.5 h-3.5 mr-1.5 text-[var(--page-secondary,#fe0000)]" />
              Moments at Milton
            </Badge>
          </motion.div>
          <motion.h1
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <TabsList className="bg-[var(--page-bg,#ffffff)] dark:bg-gray-800 p-1 rounded-xl">
                  {CATEGORIES.map((cat) => (
                    <TabsTrigger
                      key={cat.value}
                      value={cat.value}
                      className="px-5 py-2 rounded-lg text-sm font-medium data-[state=active]:bg-[var(--page-surface,white)] dark:data-[state=active]:bg-gray-700 data-[state=active]:text-[var(--page-text,#000000)] dark:data-[state=active]:text-white data-[state=active]:shadow-sm"
                    >
                      {cat.label}
                    </TabsTrigger>
                  ))}
          ...
          {filtered.length === 0 && (
            <div className="text-center py-20">
              ...
              <h3 className="text-xl font-display font-bold text-[var(--page-text,#000000)] dark:text-white mb-2">No photos found</h3>
      ...
      <section className="py-20 bg-[var(--page-bg,#ffffff)] dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeInSection>
            <Camera className="w-12 h-12 text-[var(--page-accent,#fe0000)] mx-auto mb-6" />
            <h2 className="text-4xl md:text-5xl font-display font-bold text-[var(--page-text,#000000)] dark:text-white leading-tight">
              Want to See More?{" "}
              <span className="text-[var(--page-secondary,#fe0000)]">Visit Us!</span>
            </h2>
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button size="xl" className="bg-[var(--page-secondary,#fe0000)] hover:bg-[#fe0000] text-white shadow-xl shadow-[var(--page-secondary,#fe0000)]/25">
                Schedule a Tour
                <MapPin className="ml-2 w-5 h-5" />
              </Button>
              <Button variant="outline" size="xl" className="border-[var(--page-primary,#1b3f63)]/20 text-[var(--page-text,#000000)] hover:bg-[var(--page-primary,#1b3f63)] hover:text-white">
                Virtual Tour
              </Button>
            </div>
          </FadeInSection>
