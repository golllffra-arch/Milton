  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[40vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0" style={{ background: "radial-gradient(ellipse at bottom left, color-mix(in srgb, var(--page-accent, #1b3a5c) 10%, transparent), transparent 50%)" }} />
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <motion.div
              ...
              style={{ background: "linear-gradient(135deg, var(--page-secondary, #d93a2b), #b82e21)" }}
            >
            ...
            <div className="text-center md:text-left">
              ...
              >
                BBM{" "}
                <span style={{ color: "var(--page-accent, #1b3a5c)" }}>Program</span>
              </motion.h1>
              <motion.p
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-16">
                  ...
                  return (
                    <Card key={career.title} className="border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow">
                      <CardContent className="p-5 flex gap-4">
                        <div className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0" style={{ background: "color-mix(in srgb, var(--page-secondary, #d93a2b) 10%, transparent)" }}>
            ...
            {/* Download */}
            <FadeInSection>
              <Card className="text-white border-0 shadow-xl" style={{ background: "linear-gradient(135deg, var(--page-secondary, #d93a2b), #b82e21)" }}>
              ...
              <Card className="text-white border-0 shadow-lg" style={{ background: "linear-gradient(135deg, var(--page-primary, #1b3a5c), #12283f)" }}>
                <CardContent className="p-6 text-center">
                  ...
                  <Link href="/admissions">
                    <Button className="w-full text-white" style={{ background: "var(--page-secondary, #d93a2b)" }}>
                      Apply Now
