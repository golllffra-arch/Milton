...
const RELATED_PROGRAMS = [
  { code: "bca", title: "BCA", fullName: "Bachelor of Computer Applications", icon: BookOpen, gradient: "from-[#1c3557] to-[#2c3e7a]" },
  { code: "bbm", title: "BBM", fullName: "Bachelor of Business Management", icon: BookOpen, gradient: "from-[#e31c23] to-[#a51419]" },
  { code: "bbs", title: "BBS", fullName: "Bachelor of Business Studies", icon: Users, gradient: "from-[#1c3557] to-[#0e1d31]" },
]
...
const programGradients: Record<string, React.CSSProperties> = {
  ...
  bbs: { background: "linear-gradient(135deg, var(--page-primary, #0891b2), #0e1d31)" },
}
  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[40vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0" style={{ background: "radial-gradient(ellipse at top right, color-mix(in srgb, var(--page-primary, #0891b2) 15%, transparent), transparent 60%)" }} />
        <div className="absolute inset-0 z-0" style={{ background: "radial-gradient(ellipse at bottom left, color-mix(in srgb, var(--page-secondary, #06b6d4) 8%, transparent), transparent 50%)" }} />
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <motion.div
              ...
              style={{ background: "linear-gradient(135deg, var(--page-accent, #0284c7), #a8882e)" }}
            >
            ...
            <div className="text-center md:text-left">
              ...
              >
                BASW{" "}
                <span style={{ color: "var(--page-text, #164e63)" }}>Program</span>
              </motion.h1>
              <motion.p
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-16">
                  ...
                  return (
                    <Card key={career.title} className="border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow">
                      <CardContent className="p-5 flex gap-4">
                        <div className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0" style={{ background: "color-mix(in srgb, var(--page-accent, #0284c7) 20%, transparent)" }}>
                          <Icon className="w-5 h-5" style={{ color: "var(--page-accent, #0284c7)" }} />
                        </div>
                        <div>
            ...
            {/* Download */}
            <FadeInSection>
              <Card className="text-white border-0 shadow-xl" style={{ background: "linear-gradient(135deg, var(--page-accent, #0284c7), #a8882e)" }}>
          ...
          <div className="space-y-8">
            ...
            <FadeInSection>
              <Card className="text-white border-0 shadow-lg" style={{ background: "linear-gradient(135deg, var(--page-primary, #0891b2), #0e1d31)" }}>
                <CardContent className="p-6 text-center">
                  ...
                  <Link href="/admissions">
                    <Button className="w-full text-white" style={{ background: "var(--page-accent, #0284c7)" }}>
                      Apply Now
