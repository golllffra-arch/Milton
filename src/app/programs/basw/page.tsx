  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[40vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#c9a84c]/90 via-[#c9a84c]/80 to-[#a8882e] z-0" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(28,53,87,0.15),transparent_60%)] z-0" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,rgba(227,28,35,0.08),transparent_50%)] z-0" />
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <motion.div
              ...
              className="w-24 h-24 rounded-2xl bg-gradient-to-br from-[#c9a84c] to-[#a8882e] flex items-center justify-center shrink-0 shadow-xl"
            >
            ...
            <div className="text-center md:text-left">
              ...
              >
                BASW{" "}
                <span className="text-[#1c3557]">Program</span>
              </motion.h1>
              <motion.p
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-16">
                  ...
                  return (
                    <Card key={career.title} className="border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow">
                      <CardContent className="p-5 flex gap-4">
                        <div className="w-10 h-10 rounded-lg bg-[#c9a84c]/20 dark:bg-[#c9a84c]/30 flex items-center justify-center shrink-0">
            ...
            {/* Download */}
            <FadeInSection>
              <Card className="bg-gradient-to-r from-[#c9a84c] to-[#a8882e] text-white border-0 shadow-xl">
              ...
              <Card className="bg-gradient-to-br from-[#1c3557] to-[#0e1d31] text-white border-0 shadow-lg">
                <CardContent className="p-6 text-center">
                  ...
                  <Link href="/admissions">
                    <Button className="w-full bg-[#c9a84c] hover:bg-[#b8973a] text-white">
                      Apply Now
