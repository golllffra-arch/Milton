  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      {Array.from({ length: 20 }).map((_: unknown, i: number) => (
        <div
          ...
          style={{
            ...
            top: `${Math.random() * 100}%`,
            background: i % 3 === 0 ? "var(--page-primary, #fe0000)" : i % 3 === 1 ? "var(--page-secondary, #fe0000)" : "var(--page-accent, #fe0000)",
      ...
      <div
        ...
        style={{
          background: "var(--page-primary, #fe0000)",
          width: "300px",
          height: "300px",
          top: "-10%",
          left: "-5%",
...
function StatItem({ value, label, suffix }: { value: number; label: string; suffix: string }) {
  return (
    <div className="text-center p-4">
      <div className="text-3xl md:text-4xl font-bold font-display" style={{ color: "var(--page-secondary, #fe0000)" }}>
        {value}{suffix}
      </div>
      <div className="text-sm font-medium mt-1 uppercase tracking-wider opacity-70" style={{ color: "var(--page-text, #000000)" }}>{label}</div>
    </div>
  )
}
    ...
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 text-center">
          ...
          >
            About Milton
            <br />
            <span className="bg-gradient-to-r from-[#fe0000] via-[#fe0000] to-[#fe0000] bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <FadeInSection>
              ...
              <h2 className="text-4xl md:text-5xl font-display font-bold dark:text-white leading-tight" style={{ color: "var(--page-text, #000000)" }}>
                Inspired by{" "}
                <span style={{ color: "var(--page-secondary, #fe0000)" }}>John Milton</span>
              </h2>
              <div className="mt-6 space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                <p>
                  ...
                  <strong className="dark:text-white" style={{ color: "var(--page-text, #000000)" }}>John Milton</strong>
                  ...
                  words —{" "}
                  <em className="dark:text-white" style={{ color: "var(--page-text, #000000)" }}>
                ...
                <p>
                  Established in <strong className="dark:text-white" style={{ color: "var(--page-text, #000000)" }}>2010</strong>,
            ...
            <FadeInSection>
              <div className="relative">
                <div className="absolute -top-4 -left-4 w-24 h-24 rounded-2xl" style={{ background: "color-mix(in srgb, var(--page-accent, #fe0000) 20%, transparent)" }} />
                <div className="absolute -bottom-4 -right-4 w-32 h-32 rounded-2xl" style={{ background: "color-mix(in srgb, var(--page-secondary, #fe0000) 10%, transparent)" }} />
                <div className="relative rounded-2xl p-8 shadow-xl" style={{ background: "var(--page-bg, #ffffff)" }}>
                  <h3 className="text-2xl font-display font-bold dark:text-white mb-6" style={{ color: "var(--page-text, #000000)" }}>
                    Our Journey
                  </h3>
                    ...
                    {MILESTONES.slice(0, 4).map((m, i) => (
                      <div key={m.year} className="flex gap-4">
                        <div className="flex flex-col items-center">
                          <div className="w-10 h-10 rounded-full flex items-center justify-center text-white text-sm font-bold" style={{ background: i === 0 ? "var(--page-secondary, #fe0000)" : "var(--page-primary, #fe0000)" }}>
                            {m.year.toString().slice(2)}
                          </div>
                          {i < 3 && <div className="w-0.5 h-8 bg-gray-300 dark:bg-gray-600" />}
                        </div>
                        <div className="pb-2">
                          <h4 className="font-semibold dark:text-white" style={{ color: "var(--page-text, #000000)" }}>{m.title}</h4>
              ...
              <FadeInSection key={m.year}>
                <Card className="h-full border-0 shadow-md bg-white dark:bg-gray-800 rounded-xl">
                  <CardContent className="p-6">
                    <div className="text-3xl font-display font-bold mb-2" style={{ color: "var(--page-secondary, #fe0000)" }}>{m.year}</div>
                    <h3 className="text-lg font-semibold dark:text-white mb-2" style={{ color: "var(--page-text, #000000)" }}>{m.title}</h3>
                    <p className="text-sm text-gray-500 dark:text-gray-400">{m.description}</p>
                  </CardContent>
                </Card>
              </FadeInSection>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <FadeInSection>
              <Card className="h-full border-0 shadow-lg text-white rounded-2xl overflow-hidden relative" style={{ background: "linear-gradient(135deg, var(--page-hero-from), var(--page-hero-to))" }}>
                <div className="absolute top-0 right-0 w-32 h-32 rounded-full -translate-y-1/2 translate-x-1/2" style={{ background: "color-mix(in srgb, var(--page-secondary, #fe0000) 10%, transparent)" }} />
                <CardContent className="p-8 md:p-10 relative">
                  <Target className="w-12 h-12 mb-6" style={{ color: "var(--page-accent, #fe0000)" }} />
            ...
            <FadeInSection>
              <Card className="h-full border-0 shadow-lg text-white rounded-2xl overflow-hidden relative" style={{ background: "linear-gradient(135deg, var(--page-secondary), var(--page-accent))" }}>
                <div className="absolute top-0 right-0 w-32 h-32 rounded-full -translate-y-1/2 translate-x-1/2" style={{ background: "color-mix(in srgb, var(--page-accent, #fe0000) 10%, transparent)" }} />
                <CardContent className="p-8 md:p-10 relative">
                  <Award className="w-12 h-12 mb-6" style={{ color: "var(--page-accent, #fe0000)" }} />
                  ...
                  <motion.div whileHover={{ y: -6 }} className="group h-full">
                    <Card className="h-full border-0 shadow-md hover:shadow-xl transition-all duration-300 bg-white dark:bg-gray-800 rounded-xl">
                      <CardContent className="p-8 text-center">
                        <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300" style={{ background: "color-mix(in srgb, var(--page-primary, #fe0000) 10%, transparent)" }}>
                          <Icon className="w-8 h-8" style={{ color: "var(--page-secondary, #fe0000)" }} />
                        </div>
                        <h3 className="text-xl font-display font-bold dark:text-white mb-3" style={{ color: "var(--page-text, #000000)" }}>{v.title}</h3>
      ...
      <section className="py-20 bg-white dark:bg-gray-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <FadeInSection>
              <div className="relative">
                <div className="absolute -top-4 -left-4 w-full h-full rounded-2xl" style={{ background: "color-mix(in srgb, var(--page-primary, #fe0000) 5%, transparent)" }} />
                <div className="relative rounded-2xl p-8 md:p-10 shadow-lg" style={{ background: "var(--page-bg, #ffffff)" }}>
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-16 h-16 rounded-2xl flex items-center justify-center shrink-0" style={{ background: "var(--page-primary, #fe0000)" }}>
                      <Shield className="w-8 h-8 text-white" />
                    </div>
                    <div>
                      <h3 className="text-xl font-display font-bold dark:text-white" style={{ color: "var(--page-text, #000000)" }}>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                    ...
                    <strong className="dark:text-white" style={{ color: "var(--page-text, #000000)" }}>Tribhuvan University (TU)</strong>,
            ...
            <FadeInSection>
              ...
              <h2 className="text-4xl md:text-5xl font-display font-bold dark:text-white leading-tight" style={{ color: "var(--page-text, #000000)" }}>
                TU Affiliated &<br />
                <span style={{ color: "var(--page-accent, #fe0000)" }}>Nationally Recognized</span>
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
              ...
              <div className="relative">
                <div className="w-full aspect-[4/5] rounded-2xl flex items-center justify-center shadow-xl" style={{ background: "linear-gradient(135deg, var(--page-hero-from), var(--page-hero-to))" }}>
                  <div className="text-center p-8">
                    <div className="w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6" style={{ background: "color-mix(in srgb, var(--page-accent, #fe0000) 20%, transparent)" }}>
                      <Quote className="w-10 h-10" style={{ color: "var(--page-accent, #fe0000)" }} />
                    </div>
                    <p className="text-white/60 text-sm">Photo Coming Soon</p>
                  </div>
                </div>
                <div className="absolute -bottom-4 -right-4 rounded-2xl px-6 py-3 shadow-lg" style={{ background: "var(--page-secondary, #fe0000)" }}>
            ...
            <FadeInSection className="lg:col-span-3">
              ...
              <h2 className="text-4xl md:text-5xl font-display font-bold dark:text-white leading-tight" style={{ color: "var(--page-text, #000000)" }}>
                A Message from<br />
                <span style={{ color: "var(--page-secondary, #fe0000)" }}>Our Leadership</span>
              </h2>
              <div className="mt-6 space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                <p>
              ...
              <div className="mt-8">
                <p className="font-display font-bold dark:text-white text-lg" style={{ color: "var(--page-text, #000000)" }}>Prof. Dr. [Name]</p>
      ...
      <section className="py-24 relative overflow-hidden" style={{ background: "linear-gradient(135deg, var(--page-hero-from), var(--page-hero-to))" }}>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <FadeInSection>
            <ScrollText className="w-12 h-12 mx-auto mb-6" style={{ color: "var(--page-accent, #fe0000)" }} />
            <h2 className="text-4xl md:text-5xl font-display font-bold text-white leading-tight">
              Ready to Join{" "}
              <span style={{ color: "var(--page-secondary, #fe0000)" }}>Milton?</span>
            </h2>
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/admissions">
                <Button size="xl" className="text-white shadow-xl shadow-[var(--page-glow)] group" style={{ background: "var(--page-secondary, #fe0000)" }}>
                  Apply Now
                  <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </Button>
              </Link>
              <Link href="/programs">
                <Button variant="outline" size="xl" className="hover:[background:var(--page-primary)] hover:text-white" style={{ borderColor: "var(--page-border, #e2e5ea)", color: "var(--page-text, #000000)" }}>
                  Explore Programs
                </Button>
              </Link>
            </div>
