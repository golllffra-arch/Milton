...
function StatItem({ value, label, suffix }: { value: number; label: string; suffix: string }) {
  return (
    <div className="text-center p-4">
      <div className="text-3xl md:text-4xl font-bold font-display text-[#e31c23]">
        {value}{suffix}
      </div>
      <div className="text-sm text-[#1c3557]/70 font-medium mt-1 uppercase tracking-wider">{label}</div>
    </div>
  )
}
    ...
    <div className="overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <FadeInSection>
              ...
              <h2 className="text-4xl md:text-5xl font-display font-bold text-[#1c3557] dark:text-white leading-tight">
                Inspired by{" "}
                <span className="text-[#e31c23]">John Milton</span>
              </h2>
              <div className="mt-6 space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                <p>
                  ...
                  <strong className="text-[#1c3557] dark:text-white">John Milton</strong>
                  ...
                  words —{" "}
                  <em className="text-[#1c3557] dark:text-white">
                ...
                <p>
                  Established in <strong className="text-[#1c3557] dark:text-white">2010</strong>,
            ...
            <FadeInSection>
              <div className="relative">
                <div className="absolute -top-4 -left-4 w-24 h-24 bg-[#c9a84c]/20 rounded-2xl" />
                <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-[#e31c23]/10 rounded-2xl" />
                <div className="relative bg-[#f8f6f0] dark:bg-gray-800 rounded-2xl p-8 shadow-xl">
                  <h3 className="text-2xl font-display font-bold text-[#1c3557] dark:text-white mb-6">
                    Our Journey
                  </h3>
                    ...
                    {MILESTONES.slice(0, 4).map((m, i) => (
                      <div key={m.year} className="flex gap-4">
                        <div className="flex flex-col items-center">
                          <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white text-sm font-bold ${i === 0 ? 'bg-[#e31c23]' : 'bg-[#1c3557]'}`}>
                            {m.year.toString().slice(2)}
                          </div>
                          {i < 3 && <div className="w-0.5 h-8 bg-gray-300 dark:bg-gray-600" />}
                        </div>
                        <div className="pb-2">
                          <h4 className="font-semibold text-[#1c3557] dark:text-white">{m.title}</h4>
              ...
              <FadeInSection key={m.year}>
                <Card className="h-full border-0 shadow-md bg-white dark:bg-gray-800 rounded-xl">
                  <CardContent className="p-6">
                    <div className="text-3xl font-display font-bold text-[#e31c23] mb-2">{m.year}</div>
                    <h3 className="text-lg font-semibold text-[#1c3557] dark:text-white mb-2">{m.title}</h3>
                    <p className="text-sm text-gray-500 dark:text-gray-400">{m.description}</p>
                  </CardContent>
                </Card>
              </FadeInSection>
      ...
      <section className="py-20 bg-white dark:bg-gray-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <FadeInSection>
              <Card className="h-full border-0 shadow-lg bg-gradient-to-br from-[#1c3557] to-[#0e1d31] text-white rounded-2xl overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#e31c23]/10 rounded-full -translate-y-1/2 translate-x-1/2" />
            ...
            <FadeInSection>
              <Card className="h-full border-0 shadow-lg bg-gradient-to-br from-[#e31c23] to-[#a51419] text-white rounded-2xl overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#c9a84c]/10 rounded-full -translate-y-1/2 translate-x-1/2" />
                <CardContent className="p-8 md:p-10 relative">
                  <Award className="w-12 h-12 text-[#c9a84c] mb-6" />
                  ...
                  <motion.div whileHover={{ y: -6 }} className="group h-full">
                    <Card className="h-full border-0 shadow-md hover:shadow-xl transition-all duration-300 bg-white dark:bg-gray-800 rounded-xl">
                      <CardContent className="p-8 text-center">
                        <div className="w-16 h-16 rounded-2xl bg-[#1c3557]/10 dark:bg-[#1c3557]/30 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                          <Icon className="w-8 h-8 text-[#e31c23]" />
                        </div>
                        <h3 className="text-xl font-display font-bold text-[#1c3557] dark:text-white mb-3">{v.title}</h3>
      ...
      <section className="py-20 bg-white dark:bg-gray-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <FadeInSection>
              <div className="relative">
                <div className="absolute -top-4 -left-4 w-full h-full bg-[#1c3557]/5 rounded-2xl" />
                <div className="relative bg-[#f8f6f0] dark:bg-gray-800 rounded-2xl p-8 md:p-10 shadow-lg">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-16 h-16 rounded-2xl bg-[#1c3557] flex items-center justify-center shrink-0">
                      <Shield className="w-8 h-8 text-white" />
                    </div>
                    <div>
                      <h3 className="text-xl font-display font-bold text-[#1c3557] dark:text-white">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                    ...
                    <strong className="text-[#1c3557] dark:text-white">Tribhuvan University (TU)</strong>,
            ...
            <FadeInSection>
              ...
              <h2 className="text-4xl md:text-5xl font-display font-bold text-[#1c3557] dark:text-white leading-tight">
                TU Affiliated &<br />
                <span className="text-[#c9a84c]">Nationally Recognized</span>
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
            <FadeInSection className="lg:col-span-2">
              <div className="relative">
                <div className="w-full aspect-[4/5] rounded-2xl bg-gradient-to-br from-[#1c3557] to-[#0e1d31] flex items-center justify-center shadow-xl">
                  <div className="text-center p-8">
                    <div className="w-24 h-24 rounded-full bg-[#c9a84c]/20 flex items-center justify-center mx-auto mb-6">
                      <Quote className="w-10 h-10 text-[#c9a84c]" />
                    </div>
                    <p className="text-white/60 text-sm">Photo Coming Soon</p>
                  </div>
                </div>
                <div className="absolute -bottom-4 -right-4 bg-[#e31c23] rounded-2xl px-6 py-3 shadow-lg">
            ...
            <FadeInSection className="lg:col-span-3">
              ...
              <h2 className="text-4xl md:text-5xl font-display font-bold text-[#1c3557] dark:text-white leading-tight">
                A Message from<br />
                <span className="text-[#e31c23]">Our Leadership</span>
              </h2>
              <div className="mt-6 space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                <p>
              ...
              <div className="mt-8">
                <p className="font-display font-bold text-[#1c3557] dark:text-white text-lg">Prof. Dr. [Name]</p>
      ...
      <section className="py-24 bg-white dark:bg-gray-950">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeInSection>
            <ScrollText className="w-12 h-12 text-[#c9a84c] mx-auto mb-6" />
            <h2 className="text-4xl md:text-5xl font-display font-bold text-[#1c3557] dark:text-white leading-tight">
              Ready to Join{" "}
              <span className="text-[#e31c23]">Milton?</span>
            </h2>
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
