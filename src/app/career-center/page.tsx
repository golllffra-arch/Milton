    ...
    <div className="overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 text-center">
          ...
          >
            <Badge variant="outline" className="mb-6 px-4 py-2 text-sm border-white/20 text-white/80 bg-white/5 backdrop-blur-sm">
              <Briefcase className="w-3.5 h-3.5 mr-1.5 text-[#e31c23]" />
                  ...
                  <motion.div whileHover={{ y: -6 }} className="group h-full">
                    <Card className="h-full border-0 shadow-md hover:shadow-xl transition-all duration-300 bg-white dark:bg-gray-800 rounded-xl">
                      <CardContent className="p-6 text-center">
                        <div className="w-14 h-14 rounded-2xl bg-[#1c3557]/10 dark:bg-[#1c3557]/30 flex items-center justify-center mx-auto mb-5 group-hover:scale-110 transition-transform">
                          <Icon className="w-7 h-7 text-[#e31c23]" />
                        </div>
                        <h3 className="text-lg font-display font-bold text-[#1c3557] dark:text-white mb-2">{service.title}</h3>
      ...
      <section className="py-20 bg-[#f8f6f0] dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInSection className="flex flex-col md:flex-row md:items-end md:justify-between mb-12">
            ...
            <Button variant="outline" className="mt-4 md:mt-0 border-[#1c3557]/20 text-[#1c3557]">
              View All Openings
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="font-display font-bold text-[#1c3557] dark:text-white">{job.role}</h3>
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                        ...
                        <Button variant="ghost" size="sm" className="text-[#e31c23] hover:text-[#c4181e] hover:bg-red-50 dark:hover:bg-red-950/30 p-0 h-auto font-semibold text-sm">
                          Apply Now
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <FadeInSection>
              ...
              <h2 className="text-4xl md:text-5xl font-display font-bold text-[#1c3557] dark:text-white leading-tight">
                Resume Building<br />
                <span className="text-[#e31c23]">Tips & Resources</span>
              </h2>
              ...
              <ul className="mt-8 space-y-4">
                {[
                  ...
                  <li key={tip.text} className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-lg bg-[#1c3557]/10 dark:bg-[#1c3557]/30 flex items-center justify-center shrink-0 mt-0.5">
                      <tip.icon className="w-4 h-4 text-[#e31c23]" />
                    </div>
            ...
            <FadeInSection>
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-[#1c3557] to-[#0e1d31] rounded-2xl p-8 md:p-10 shadow-xl overflow-hidden">
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(227,28,35,0.1),transparent_60%)]" />
                  <FileText className="w-16 h-16 text-[#c9a84c] mb-6 relative z-10" />
                  ...
                  <Card className="h-full border-0 shadow-md hover:shadow-xl transition-all duration-300 bg-white dark:bg-gray-800 rounded-xl overflow-hidden">
                    <CardContent className="p-6">
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div>
                          <h3 className="font-display font-bold text-[#1c3557] dark:text-white">{alumnus.name}</h3>
                      ...
                      <div className="relative pl-6 border-l-2 border-[#c9a84c]/30">
                        <Quote className="w-4 h-4 text-[#c9a84c] absolute -left-2 -top-1" />
                ...
                <motion.div whileHover={{ y: -4, scale: 1.02 }}>
                  <Card className="border-0 shadow-sm hover:shadow-md transition-all bg-white dark:bg-gray-800 rounded-xl">
                    <CardContent className="p-6 text-center">
                      ...
                      <p className="text-xs font-medium text-[#1c3557] dark:text-white leading-tight">{partner.name}</p>
                    </CardContent>
                  </Card>
                </motion.div>
              </FadeInSection>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeInSection>
            <Handshake className="w-12 h-12 text-[#c9a84c] mx-auto mb-6" />
            <h2 className="text-4xl md:text-5xl font-display font-bold text-white leading-tight">
              Ready to Launch Your{" "}
              <span className="text-[#e31c23]">Career?</span>
            </h2>
