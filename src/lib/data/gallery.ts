...
export const GALLERY_ALBUMS: GalleryAlbum[] = [
  {
    ...
    color: "from-green-600 to-emerald-800", coverDescription: "Students competing in various sports events",
    date: "March 2026",
    images: [
  ...
  },
  {
    ...
    color: "from-blue-600 to-indigo-800", coverDescription: "Students participating in coding challenge",
    date: "February 2026",
    images: [
  ...
  },
  {
    ...
    color: "from-amber-600 to-yellow-800", coverDescription: "Our well-stocked library facility",
    date: "2026",
    images: [
  ...
  },
  {
    ...
    color: "from-red-600 to-rose-800", coverDescription: "Dashain festival celebration on campus",
    date: "October 2025",
    images: [
  ...
  },
  {
    ...
    color: "from-cyan-600 to-teal-800", coverDescription: "Students on educational tour to Singapore",
    date: "January 2026",
    images: [
  ...
  },
  {
    ...
    color: "from-purple-600 to-violet-800", coverDescription: "Students in modern computer lab",
    date: "2026",
    images: [
  ...
  },
  {
    ...
    color: "from-orange-600 to-red-800", coverDescription: "Debate competition between colleges",
    date: "December 2025",
    images: [
  ...
  },
  {
    ...
    color: "from-emerald-600 to-green-800", coverDescription: "Inter-class basketball competition",
    date: "February 2026",
    images: [
      { src: "", caption: "Tip-off" },
  ...
  },
  {
    ...
    color: "from-pink-600 to-rose-800", coverDescription: "Students showcasing cultural performances",
    date: "November 2025",
    images: [
  ...
  },
  {
    ...
    color: "from-sky-600 to-blue-800", coverDescription: "Industry visit to Dubai",
    date: "December 2025",
    images: [
  ...
  },
  {
    ...
    color: "from-fuchsia-600 to-purple-800", coverDescription: "Welcome party for new students",
    date: "November 2025",
    images: [
  ...
  },
  {
    ...
    color: "from-teal-600 to-cyan-800", coverDescription: "Students volunteering at local orphanage",
    date: "January 2026",
    images: [
  ...
  },
  {
    ...
    color: "from-indigo-600 to-blue-800", coverDescription: "Visiting universities in Malaysia",
    date: "January 2026",
    images: [
