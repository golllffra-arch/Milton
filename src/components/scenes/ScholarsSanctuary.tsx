  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden" style={{ opacity: 0.4 }}>
      ...
      <div 
        ...
        style={{ background: "linear-gradient(to bottom, #12283f 0%, #1b3a5c 35%, #b82e21 70%, #d93a2b 100%)" }} 
      />
      ...
      <svg className="absolute bottom-0 w-full h-full" viewBox="0 0 1440 900" preserveAspectRatio="xMidYMax slice">
        ...
        {/* Back Hills */}
        <path d="M0,650 Q250,550 500,600 T1000,550 T1440,620 L1440,900 L0,900 Z" fill="#12283f" opacity="0.5" />
        {/* Mid Hills */}
        <path d="M0,700 Q300,620 700,680 T1440,650 L1440,900 L0,900 Z" fill="#0b1522" opacity="0.6" />
        
        {/* Library Silhouette Building */}
        <path d="M350,750 L350,300 L720,200 L1090,300 L1090,750 Z" fill="#0b1522" opacity="0.9"/>
        ...
        <path d="M350,700 Q370,650 340,600 T360,500 T340,400" fill="none" stroke="#12283f" strokeWidth="8" strokeLinecap="round"/>
        <path d="M1090,700 Q1070,680 1100,600 T1080,520 T1100,450" fill="none" stroke="#12283f" strokeWidth="10" strokeLinecap="round"/>
        {/* Leaf dots on vines */}
        {Array.from({length: 40}).map((_: unknown, i) => (
          <circle key={`ivy1-${i}`} cx={345 + Math.random()*20 - 10} cy={400 + i*8} r={Math.random()*4+2} fill="#12283f" opacity="0.8"/>
        ))}
        {Array.from({length: 40}).map((_: unknown, i) => (
          <circle key={`ivy2-${i}`} cx={1085 + Math.random()*20 - 10} cy={450 + i*7} r={Math.random()*4+2} fill="#12283f" opacity="0.8"/>
        ))}

        {/* Book Stacks Foreground */}
        <g transform="translate(100, 700)">
          <rect x="0" y="50" width="120" height="30" rx="3" fill="#020617"/>
          <rect x="10" y="25" width="100" height="25" rx="3" fill="#0b1522" transform="rotate(-5)"/>
          <rect x="-5" y="0" width="130" height="25" rx="3" fill="#12283f"/>
          <rect x="20" y="-30" width="90" height="30" rx="3" fill="#0b1522" transform="rotate(8)"/>
        </g>
        <g transform="translate(1150, 650)">
          <rect x="10" y="100" width="150" height="35" rx="3" fill="#020617"/>
          <rect x="0" y="65" width="160" height="35" rx="3" fill="#12283f"/>
          <rect x="20" y="40" width="130" height="25" rx="3" fill="#0b1522"/>
        ...
        <g transform="translate(250, 680) rotate(-15)">
          <polygon points="0,0 15,0 25,60 -10,60" fill="#0b1522" />
