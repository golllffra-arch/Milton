  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden opacity-40">
      ...
      <svg className="absolute bottom-0 w-full min-w-[1440px] min-h-[900px]" viewBox="0 0 1440 900" preserveAspectRatio="xMidYMax slice">
        ...
        {/* Soft Rolling Hills */}
        <path d="M0 650 Q200 550 450 620 T950 580 T1440 680 L1440 900 L0 900 Z" fill="#1b3f63" opacity="0.7" />
        <path d="M0 720 Q300 620 600 700 T1150 640 T1440 750 L1440 900 L0 900 Z" fill="#000000" opacity="0.85" />
        <path d="M0 800 Q350 720 720 820 T1440 780 L1440 900 L0 900 Z" fill="#000000" />

        {/* Campus Buildings in distance */}
        <g transform="translate(620, 560) scale(0.6)">
          <path d="M0 200 L0 80 L80 80 L80 0 L140 0 L140 80 L220 80 L220 200 Z" fill="#000000" />
          {/* Lit Windows */}
        ...
        {/* Trees */}
        <path d="M150 750 C120 680 180 640 220 690 C250 660 300 710 270 760 Z" fill="#000000" />
        <path d="M1250 780 C1220 700 1290 650 1340 710 C1380 670 1440 730 1400 790 Z" fill="#000000" />

        {/* Walking Student Silhouettes */}
        <g transform="translate(450, 720) scale(0.8)">
          <circle cx="30" cy="20" r="12" fill="#000000" />
          <path d="M20 40 L40 40 L50 80 L35 80 L30 60 L25 80 L10 80 Z" fill="#000000" />
          <path d="M15 45 L5 70 L12 73 L20 55 Z" fill="#000000" />
          <path d="M45 45 L55 60 L48 65 L40 55 Z" fill="#000000" />
          <rect x="10" y="35" width="20" height="25" fill="#000000" />
        </g>

        <g transform="translate(520, 735) scale(0.7)">
          <circle cx="30" cy="20" r="11" fill="#000000" />
          <path d="M22 38 L38 38 L45 75 L33 75 L30 55 L27 75 L15 75 Z" fill="#000000" />
          <path d="M18 42 L8 65 L14 68 L22 52 Z" fill="#000000" />
          <rect x="15" y="35" width="25" height="22" fill="#000000" />
        </g>
        
        <g transform="translate(380, 750) scale(0.85)">
          <circle cx="30" cy="20" r="13" fill="#000000" />
          <path d="M18 42 L42 42 L52 85 L36 85 L30 62 L24 85 L8 85 Z" fill="#000000" />
          <path d="M42 45 L50 70 L43 74 L37 55 Z" fill="#000000" />
          <rect x="25" y="35" width="25" height="30" rx="5" fill="#000000" />
        </g>
      </svg>
