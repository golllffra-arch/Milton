    ...
    <div className="fixed inset-0 -z-10 overflow-hidden">
      ...
      <svg className="absolute bottom-0 w-full opacity-60" viewBox="0 0 1440 900" preserveAspectRatio="xMidYMax slice">
        ...
        <g transform="translate(1200, 900)">
          ...
          {/* Hanging frames */}
          <line x1="-30" y1="-600" x2="-30" y2="-500" stroke="#dce5f0" strokeWidth="1" strokeDasharray="4" opacity="0.5" />
          <rect x="-50" y="-500" width="40" height="50" fill="none" stroke="#dce5f0" strokeWidth="3" opacity="0.6" transform="rotate(5 -30 -500)" />
          
          <line x1="80" y1="-550" x2="80" y2="-450" stroke="#dce5f0" strokeWidth="1" strokeDasharray="4" opacity="0.5" />
          <rect x="60" y="-450" width="40" height="30" fill="none" stroke="#dce5f0" strokeWidth="3" opacity="0.6" transform="rotate(-10 80 -450)" />
        </g>
      ...
      {bokeh.map(b => (
        <div
          ...
          style={{
            ...
            width: `${b.size}px`,
            height: `${b.size}px`,
            background: 'radial-gradient(circle, rgba(220,229,240,0.15) 0%, rgba(220,229,240,0) 70%)',
      ...
      {frames.map(f => (
        ...
        >
          <div className="w-24 h-32 border-4 border-[#f5c9c4]/40 bg-white/5 shadow-lg backdrop-blur-sm p-2 flex flex-col justify-between">
      ...
      {sparkles.map(s => (
        ...
        >
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" opacity="0.6">
            <path d="M8,0 Q8,8 16,8 Q8,8 8,16 Q8,8 0,8 Q8,8 8,0 Z" fill="#f5c9c4" />
          </svg>
        </div>
      ))}
