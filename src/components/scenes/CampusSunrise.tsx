      ...
      <svg className="absolute bottom-0 w-full min-w-[1440px] min-h-[900px]" viewBox="0 0 1440 900" preserveAspectRatio="xMidYMax slice">
        <defs>
          <radialGradient id="campus-sun-glow" cx="50%" cy="50%" r="50%">
            ...
            <stop offset="30%" stopColor="#fe0000" stopOpacity="0.8" />
        ...
        {/* Mountains - Far */}
        <path d="M0 600 L120 480 L280 580 L450 420 L600 580 L750 450 L900 560 L1080 390 L1250 580 L1350 490 L1440 600 L1440 900 L0 900 Z" fill="#1b3f63" opacity="0.6" />
        
        {/* Mountains - Mid */}
        <path d="M0 650 L220 520 L380 620 L550 460 L700 640 L850 490 L1000 640 L1150 490 L1300 620 L1440 520 L1440 900 L0 900 Z" fill="#1b3f63" opacity="0.8" />
        
        {/* Mountains - Near */}
        <path d="M0 720 L320 570 L480 690 L650 590 L800 720 L950 570 L1100 690 L1250 590 L1440 670 L1440 900 L0 900 Z" fill="#000000" />
        
        {/* Campus Buildings */}
        <path d="M250 750 L250 630 L320 630 L320 600 L380 600 L380 630 L450 630 L450 750 Z" fill="#000000" />
        <path d="M480 750 L480 560 L540 510 L600 560 L600 750 Z" fill="#000000" />
        <path d="M630 750 L630 580 L770 580 L770 750 Z" fill="#000000" />
        <path d="M660 580 C660 520 740 520 740 580 Z" fill="#000000" />
        <path d="M820 750 L820 610 L940 610 L940 640 L1020 640 L1020 750 Z" fill="#000000" />
        <path d="M1060 750 L1060 650 L1180 650 L1180 750 Z" fill="#000000" />

        {/* Trees Left */}
        <path d="M-20 750 C10 680 70 630 120 680 C160 650 200 700 180 750 Z" fill="#000000" />
        <path d="M80 750 C60 710 120 660 160 710 C190 680 230 720 210 750 Z" fill="#000000" />
        
        {/* Trees Right */}
        <path d="M1250 750 C1230 690 1290 640 1340 690 C1380 660 1420 710 1400 750 Z" fill="#000000" />
        <path d="M1320 750 C1300 710 1360 660 1400 710 C1430 680 1460 720 1440 750 Z" fill="#000000" />
        
        {/* Pond/Water Reflection */}
        <path d="M0 750 L1440 750 L1440 900 L0 900 Z" fill="#000000" />
        ...
        >
          <div style={{ transform: `scale(${b.scale})` }}>
            <svg width="40" height="25" viewBox="0 0 40 25">
              <path d="M0,12 Q10,0 20,12 Q30,0 40,12 Q30,6 20,18 Q10,6 0,12 Z" fill="#000000" />
            </svg>
          </div>
        </div>
      ))}
