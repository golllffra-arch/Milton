  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden">
      ...
      <svg className="absolute bottom-0 w-full opacity-70" viewBox="0 0 1440 900" preserveAspectRatio="xMidYMax slice">
        <defs>
          ...
          <radialGradient id="pano-beam" cx="50%" cy="100%" r="100%">
            ...
            <stop offset="100%" stopColor="#dce5f0" stopOpacity="0" />
          </radialGradient>
        </defs>
        ...
        {/* Grid Lines */}
        <g stroke="#dce5f0" strokeWidth="1" opacity="0.15">
        ...
        {/* Compass Rose */}
        <g transform="translate(1300, 150)" opacity="0.4" stroke="#dce5f0">
          ...
          <text x="-4" y="-70" fill="#dce5f0" stroke="none" fontSize="14" fontFamily="sans-serif">N</text>
        </g>
      ...
      {dots.map(d => (
        <div
          key={`dot-${d.id}`}
          className="absolute rounded-full bg-[#dce5f0] pano-pulse-dot"
          style={{
            left: `${d.x}%`,
            top: `${d.y}%`,
            width: '6px',
      ...
      <style>{`
        ...
        @keyframes pano-pulse-dot {
          0% { transform: scale(1); opacity: 1; box-shadow: 0 0 0 0 rgba(220, 229, 240, 0.7); }
          70% { transform: scale(1.5); opacity: 0; box-shadow: 0 0 0 10px rgba(220, 229, 240, 0); }
